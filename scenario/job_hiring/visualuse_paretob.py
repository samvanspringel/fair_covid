...
if __name__ == '__main__':
    ...
    file = "./wandb/run-20230417_102602-trv08xuf/files/media/table/nd_coverage_set_10016_94b05680a39d684062fa.table.json"
    res_file = "./pcn/tmp/jobhiring/objectives_[0, 1]/env_ode/action_discrete/lr_0.01/steps_10000.0/batch_128/model_updates_20/top_episodes_10/n_episodes_10/er_size_100/threshold_0.02/noise_0.0/model_conv1dsmall/2023-04-17_10-26-00_4bea/fair_results_10.pt"
    ...
    # TODO: reward is scaled, but scale back down withing fairness notions for the radarplot
    df["reward"] /= 5
    # print(df)
    ...
    fdfr = full_df["reward"]
    print(fdfr.min(), fdfr.max(), fdfr.mean(), fdfr.std(), fdfr.median(),)
